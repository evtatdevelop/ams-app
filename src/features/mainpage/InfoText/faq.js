    ...
    <article className={styles.faq}>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>- добавить развернутое обоснование к конфликту и повторно нажать "Отправить заявку на согласование" (если конфликт не является блокирующим)</li>
            <li>- удалить конфликтующую роль из заявки, и далее повторно нажать "Отправить заявку на согласование"</li>
